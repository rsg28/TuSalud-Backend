...
CREATE TABLE `historial_pedido` (
  ...
  `pedido_id` int NOT NULL,
  `cotizacion_id` int DEFAULT NULL,
  `tipo_evento` enum('CREACION','COTIZACION_ENVIADA','COTIZACION_APROBADA','COTIZACION_RECHAZADA','SOLICITUD_MANAGER','PRECIO_APROBADO','FACTURA_EMITIDA','FACTURA_ANULADA','FACTURA_ENVIADA_CLIENTE','PAGO_RECIBIDO','COTIZACION_ELIMINADA','PEDIDO_COMPLETADO','WHATSAPP_COTIZACION_ENVIADA') NOT NULL,
